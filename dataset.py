...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='../../yingke-data/leison-2018/data/')
    parser.add_argument('--origin_GT_path', type=str, default='../../yingke-data/leison-2018/ground-truths/ISIC2018_Task1_Training_GroundTruth')
